...
import 'toutes_attributions_model.dart';
export 'toutes_attributions_model.dart';
...
class _ToutesAttributionsWidgetState extends State<ToutesAttributionsWidget> {
  late ToutesAttributionsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ToutesAttributionsModel());
