...
import 'lesmieu_note_model.dart';
export 'lesmieu_note_model.dart';

class LesmieuNoteWidget extends StatefulWidget {
  const LesmieuNoteWidget({
    Key? key,
    this.res,
  }) : super(key: key);
  ...
  @override
  _LesmieuNoteWidgetState createState() => _LesmieuNoteWidgetState();
}

class _LesmieuNoteWidgetState extends State<LesmieuNoteWidget> {
  late LesmieuNoteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LesmieuNoteModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'lesmieuNote'});
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<RestaurantsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final lesmieuNoteRestaurantsRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
                      ...
                      child: StreamBuilder<List<ProduitsRecord>>(
                        stream: queryProduitsRecord(
                          queryBuilder: (produitsRecord) => produitsRecord
                              .where('restaurant',
                                  isEqualTo: lesmieuNoteRestaurantsRecord.nom)
