...
class _AjoutPlatWidgetState extends State<AjoutPlatWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AjoutPlatModel());
                                                                                              ...
                                                                                              Expanded(
                                                                                                child: StreamBuilder<List<RestaurantsRecord>>(
                                                                                                  ...
                                                                                                  builder: (context, snapshot) {
                                                                                                    ...
                                                                                                    List<RestaurantsRecord> sector222RestaurantsRecordList = snapshot.data!;
                                                                                                    return FlutterFlowDropDown<String>(
                                                                                                      controller: _model.sector222Controller ??= FormFieldController<String>(null),
                                                                                                      options: sector222RestaurantsRecordList.map((e) => e.nom).withoutNulls.toList().toList(),
                                                                                                      onChanged: (val) => setState(() => _model.sector222Value = val),
                                                                                                      width: 180.0,
                                                                                                      height: 80.0,
                                                                                                      textStyle: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                            fontFamily: 'sf pro text',
                                                                                                    ...
                                                                                                    onPressed: () async {
                                                                                                      final produitsCreateData = {
                                                                                                        ...createProduitsRecordData(
                                                                                                          ...
                                                                                                          ouv: _model.datePicked3,
                                                                                                          clo: _model.datePicked4,
                                                                                                          defaut: true,
                                                                                                          moyenne: 4.5,
                                                                                                          nbreFav: 0,
                                                                                                          nbreAvis: 0,
                                                                                                          ...
                                                                                                          pourcentage: 0,
                                                                                                          restaurant: _model.sector222Value,
                                                                                                          prio: 5,
                                                                                                        ),
                                                                                                        'favoris': ['null'],
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: List.generate(columnProduitsRecordList.length, (columnIndex) {
                                                                                ...
                                                                                return CardProWidget(
                                                                                  key: Key('Keygky_${columnIndex}_of_${columnProduitsRecordList.length}'),
