...
import 'nos_recommandations_model.dart';
export 'nos_recommandations_model.dart';
...
class _NosRecommandationsWidgetState extends State<NosRecommandationsWidget> {
  late NosRecommandationsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NosRecommandationsModel());
